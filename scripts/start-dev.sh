...
# Seed admin accounts
/usr/local/bin/vault-auth.sh envconsul -config=/etc/envconsul/config.hcl -- pnpm run seed:admin:prod

/usr/local/bin/vault-auth.sh envconsul -config=/etc/envconsul/config.hcl -- pnpm run seed:dev
