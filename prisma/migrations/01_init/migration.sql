...
-- CreateEnum
CREATE TYPE "notifications"."notification_type" AS ENUM ('FRIEND_REQUEST', 'FRIEND_ACCEPTED', 'SESSION_INVITATION', 'SESSION_UPDATED', 'SESSION_CANCELLED', 'SESSION_REMINDER', 'NEW_MESSAGE', 'GENERAL', 'EMAIL_VERIFIED', 'MESSAGE_SENT', 'MESSAGES_READ', 'CONVERSATION_READ', 'SESSION_PLAYER_ADDED', 'MESSAGE_DELETED');
