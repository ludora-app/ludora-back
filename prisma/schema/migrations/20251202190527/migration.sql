...
CREATE TABLE "sessions"."Sessions" (
    ...
    "sport" TEXT NOT NULL,
    "game_mode" "sessions"."GameModes" NOT NULL,
...
CREATE TABLE "sessions"."Session_teams" (
    "uid" TEXT NOT NULL,
    "session_uid" TEXT NOT NULL,
    "team_label" "sessions"."TeamLabel" NOT NULL,
...
CREATE TABLE "social"."Messages" (
    ...
    "status" "social"."MessageStatus" NOT NULL DEFAULT 'SENT',
